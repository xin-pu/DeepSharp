...
{
	/// <summary>
	///     Monte Carlo method â€?off-policy learning. (Known issue with GetTransitPer, 2023/7/3)
	/// </summary>
	public class MonteCarloOffPolicy : TabularAgent
	{
		public MonteCarloOffPolicy(EnvironmentBase<Space, Space> env, float epsilon = 0.1f, int t = 10)
		...
		private float GetTransitPer(Step step)
		{
			...
			var actionSpace = EnvironmentBase.ActionSpace!.N;
			var e           = 1f;
